          ...
          <div className="bg-white shadow rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="relative">
                ...
                />
               <img src="/search.png" alt="Upload Icon" className="w-4 h-4 mb-4 absolute right-2  top-4" />
              </div>
            </div>

            <div className="overflow-x-auto">
              <table className="min-w-full table-auto border border-gray-400 rounded-lg overflow-hidden">
